...
**Amended-by:** [[0004-attack-model-item-roles-and-recursive-delivery|ADR-0004]] (2026-06-23) — the
`Self` delivery flag is relocated to a standalone **Affinity** axis (hostile/friendly/self) + a
self/origin **Anchor** option; `Single`/`Line`/`Cleave`/`Aoe` remain the canonical patterns.
