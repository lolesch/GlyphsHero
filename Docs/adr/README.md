...
| [0010](0010-tooltip-two-tier-disclosure.md) | Tooltip is a two-tier disclosure: Tier-1 active-context only, Details mode is the "why" layer | Accepted, design-only — not implemented |
